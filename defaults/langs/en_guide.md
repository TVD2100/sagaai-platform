...
💡 **Tip:** API keys can also be set via environment variables `SAGAAI_<SERVICE>_KEY` - this is more secure.

### 2. 🔧 Configure DevAgent

> **Page:** Sidebar → DevAgent → «Settings» tab
...
- The authentication system protects access to the platform.
