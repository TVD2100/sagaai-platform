...
description: How to use GitHub connection tools (list/create repos, read/upload/update files). Load this instruction when the task involves GitHub repositories.
---
