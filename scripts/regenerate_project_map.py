...
roles = {
    ...
    "dev_agent/agent_loop.py": "Provider-independent agent loop (strong/weak assistant routing, economy mode, skills-library tools classified as weak; per-tool failure counter, duplicate-call flood compaction, cascading JSON repair)",
